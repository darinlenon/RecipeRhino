let recipes = [
    ...
    },
    {
        ...
        ingredients: [
            ...
            '3/4 cup milk',
            'pepper (to taste)',
            'onion powder (to taste 2-4 teaspoon.)'
        ],
    ...
    },
    {
        ...
        recipe_blurb: "This took some time to figure out, but it was definitely worth the wait. try it just the perfect amount of heat.",
        ingredients: [
            '2 1/4 cups brown sugar',
            '3/4 cup rounded off diced pickled jalapeños, drained',
            '1 1/2 teaspoon. granulated garlic (not powder) (I usually find it in the Mexican spice section)',
            '1 1/2 teaspoon. kosher salt (I use coarse but I don’t think it would matter. Just habit.)',
    ...
    },
    {
        ...
        rating: "10",
        recipe_img: "Peanut_Blueberry_Dog_Treats.jpg",
        time_total_image: '30',
        yield_image: '48',
        prep_time_image: '10',
        cook_time_image: '20',
        ...
        course: 'tr',
        skill_level: 'be',
        pdf: 'Peanut_Blueberry_Dog_Treats',
    ...
    },
    {
        ...
        ingredients: [
            ...
            '2 tablespoon finely grated Parmigiano- Reggiano cheese',
            '1 tablespoon sugar'
        ],
        serving_size: '1/4 cup',
        total_servings: '8',
    ...
    },
    {
        ...
        tips_var: [
            "^If you love coconut add 1/4 - 1/2 for a nice tropical treat."
        ],
        tags: [
            'pineapple',
            'marshmellows',
